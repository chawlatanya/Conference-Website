<template>
  <div class="position-fixed navbar w-100">
       <div class="d-md-none">
        ...
        <img src="../../assets/images/logo.png" height="40rem" width="40rem">
      </div>
      ...
      <div class="d-md-none">
      <div
        :class="{'mobile_menu_inactive':!hamburgerActive,'mobile_menu':hamburgerActive}"
      >
    ...
    <div class="d-none d-md-block bg-sidebar-dark p-3 rounded push" :class="{scrolled:!isTop}">
      <div
